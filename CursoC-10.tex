...
Por ejemplo, para punteros a carácter, la instrucción p++ incrementa el valor
del puntero en uno,que es el sizeof() de los chars; pero si p es un puntero a
long, en una arquitectura donde los longs miden cuatro bytes, p++ incrementa el
valor de p en cuatro (y p queda apuntando \quotes{un long más allá en la memoria}). El
cálculo realizado al tiempo de ejecución para la instrucción p+i, donde p es un
puntero a tipo e i es un entero, es siempre p+i*sizeof(tipo).
