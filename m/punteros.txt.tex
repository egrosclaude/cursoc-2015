...
\choice \code{*p}
\choice \quotes{a cadena apuntada por \code{p}}.
...
\choice un arreglo.
\choice un puntero a una cadena terminada en \code{"0"}.
...
\correctchoice la dirección de la cadena \code{"beta"}.
\choice la dirección de la cadena \code{"alfa"}.
\choice la letra 'l' dentro de la cadena \code{"alfa"}.
\choice la letra 'b' dentro de la cadena \code{"beta"}.
\choice Ninguna de las anteriores.

\question Con la declaración \code{char *a[] = \{"alfa", "beta", "gamma" \};} se tiene que \code{*a[1]} equivale a:
\choice la dirección de la cadena \code{"beta"}.
\choice la dirección de la cadena \code{"alfa"}.
\choice la letra 'l' dentro de la cadena \code{"alfa"}.
\correctchoice la letra 'b' dentro de la cadena \code{"beta"}.
\choice Ninguna de las anteriores.

\question Con la declaración \code{char *a[] = \{"alfa", "beta", "gamma" \};}, la letra \code{'t'} dentro de la cadena \code{"beta"} se puede escribir como:
\choice \code{a[1][2]}.
\choice \code{*(a[1]+2)}.
\choice \code{*(*(a+1)+2)}.
\correctchoice Todas las anteriores.
