...
\setlength{\cftsubsecnumwidth}{6.8em}% Set length of number width in ToC for \subsection
...
\newenvironment{preguntas}{%
	\section{Preguntas para el Capítulo \thechapter}
	\begin{questions}
}{%
	\end{questions}
	\newpage
	\subsection{Respuestas al Capítulo \thechapter}
	\showanswers
}%
